...
{
    public partial class AdminDeposit : System.Web.UI.Page
    {
        ...
        {
            String sql = "";
            sql = "Insert into [Deposit](id , amount,time , invoiceNumber, notes, IdUser) values('" + TextBoxID.Text + "' , '" + TextBoxAmount.Text + "' , '" + TextBoxDate.Text + "' ,  '" + TextBoxInvNum.Text + "' , N'" + TextBoxNotes.Text + "' , '" + TextBoxIDUser.Text + "')";
