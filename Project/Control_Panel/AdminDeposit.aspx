<%@ Page Title="" Language="C#" MasterPageFile="~/Control_Panel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="AdminDeposit.aspx.cs" Inherits="Project.Control_Panel.AdminDeposit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <h3 style="margin-right: 30px;">كشف الإيداع
    </h3>
    ...
    <div class="but">
        ...
        <div style="margin: 0 30px; margin-top: 60px;">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" CssClass="table table-striped" AllowPaging="True">
                <Columns>
                    ...
                    <asp:BoundField DataField="time" HeaderText="الوقت" SortExpression="time" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Deposit]" DeleteCommand="DELETE FROM [Deposit] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Deposit] ([Id], [amount], [time], [invoiceNumber], [notes], [IdUser]) VALUES (@Id, @amount, @time, @invoiceNumber, @notes, @IdUser)" UpdateCommand="UPDATE [Deposit] SET [amount] = @amount, [time] = @time, [invoiceNumber] = @invoiceNumber, [notes] = @notes, [IdUser] = @IdUser WHERE [Id] = @Id">
            <DeleteParameters>
